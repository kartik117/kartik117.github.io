...
React 19 · React Router · Framer Motion · Vite · deployed to GitHub Pages via `gh-pages`
...
A GitHub Actions workflow also deploys automatically on every push to `main`.
